...
<header class="py-5" id="header" style="background-color: #78edff">
    <div class="container">
        <h1 class="text-center text-white">My Team Summary</h1>
    </div>
</header>
...
// Function will return a html card with employee details
function dynamicContent(obj) {
  ...
  if (obj.getRole() === "Manager") {
    ...
    console.log("That role does not exist at this company");
  }
  return `
        <div class="col-sm">
          <div class="card shadow-lg  mb-5  rounded" style="width: 18rem;">
            <div class="p-4" style="background-color: #ff7878">
